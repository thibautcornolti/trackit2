...
func main() {
	...
	//ress, err := costs.GetElasticSearchParams([]string{"394125495069"}, time.Date(2017, 10, 1, 0, 0, 0, 0, time.Local), time.Date(2017, 11, 1, 0, 0, 0, 0, time.Local), []string{"account", "product"}, client, "awsdetailedlineitem").Do(context.Background())
